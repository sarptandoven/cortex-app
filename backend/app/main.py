...
def download_page() -> Response:
    ...
    dmg_url = "https://github.com/doppl-tech/releases/releases/download/v0.2.0-39/Cortex-0.2.0-39.dmg"
    body = (
        ...
        '<a href="/downloads/Cortex-0.2.0-39.checksums.txt">Verify the checksums</a>.</p>\n'
        "    <h2>Install</h2>\n"
        "    <ul>\n"
