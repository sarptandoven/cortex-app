        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "associative": {
                    "type": "boolean",
                    "default": False,
                    "description": "Use bounded trust-aware multi-hop associative recall.",
                },
                "association_mode": {
                    "type": "string",
                    "enum": ["one_hop", "bounded", "ppr"],
                    "description": "Advanced deterministic comparison mode; associative must be true.",
                },
            },
            "required": ["query"],
        },
