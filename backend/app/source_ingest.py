...
# Python's stdlib JSON decoder uses the interpreter recursion limit while
# materializing deeply nested but valid JSON. Keep enough headroom for the
# importer to decode a pathological file, then rely on the explicit traversal
# caps below to degrade safely instead of overflowing while extracting text.
