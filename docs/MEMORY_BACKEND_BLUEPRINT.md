...
- Scoped `cxa_` REST tokens can now resolve a user before shard routing, and `CORTEX_REQUIRE_SCOPED_API_TOKENS=1` disables global-token user switching for hosted-style runs.
